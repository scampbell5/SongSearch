...
public class RALtester3 {
   public static void main(String[] args) throws FileNotFoundException {
      ...
      for (String aRalist : ralist) System.out.print("[" + aRalist + "]");
      System.out.println();
    ...
    * DO NOT MODIFY I WILL BE USING THIS FOR MY TESTING
    */
   public static void stats(RaggedArrayList<String> ralist, Comparator<String> comp){
      ...
      System.out.println("level 1 array " + l1NumUsed + " of " + ralist.l1Array.length + " used.");
      ...
      System.out.printf("level 2 array sizes: min = %d used, avg = %.1f used, max = %d used\n", 
